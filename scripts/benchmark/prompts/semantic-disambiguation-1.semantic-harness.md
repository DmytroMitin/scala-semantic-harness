...
Goal:
Fix the project so that the success command passes by choosing the intended symbol or type.
...
- "$SEMANTIC_SCALA_CMD" symbol-at --file src/main/scala/example/Main.scala --line 13 --col 23 --json
...
- Determine which symbol or type is actually intended before patching.
- Semantic evidence may help distinguish similarly named wrappers.
