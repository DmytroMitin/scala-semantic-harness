...
Goal:
Fix the project so that the success command passes without relying on display-name assumptions.
...
- "$SEMANTIC_SCALA_CMD" symbol-at --file src/main/scala/example/Main.scala --line 14 --col 35 --json
...
- Use semantic evidence carefully when similar functions or wrapper types exist.
