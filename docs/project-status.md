...
| Compiler-plugin PC-context evidence | `EVIDENCE_PARTIAL` | Feasibility and design evidence admit a bounded post-compile TASTy evidence plus Presentation Compiler context-provenance implementation. No implemented product contract or general compiler-plugin semantic claim exists yet. |
