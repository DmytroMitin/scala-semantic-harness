...
development. Bounded post-compile TASTy evidence now covers two independent
compiler-plugin cases across the qualified sbt 1 and sbt 2 rows, while broader
compiler-plugin semantics remain evidence-partial and outside any READY claim.
